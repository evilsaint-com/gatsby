...
const enhanceMdxOptions = async (pluginOptions, helpers) => {
  ...
  } = await (0, _cacheHelpers.cachedImport)(`remark-unwrap-images`); // Set jsxRuntime & jsxImportSource based on Gatsby project config
  ...
  options.mdxOptions.remarkPlugins.push(remarkUnwrapImages); // Inject Gatsby path prefix if needed
  ...
  options.mdxOptions.remarkRehypeOptions.passThrough = passThrough; // Extract metadata generated from by rehype-infer-* and similar plugins
