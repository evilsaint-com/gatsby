...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
  <img src="f6bf486c-d485-4ce9-90ab-9edd74ab6198.png" class="img-fluid" alt="VMware Workstation cannot connect to the virtual machine.">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
  <img src="a0884e80-3f2f-4f17-9a2e-a2df961785f8.png" class="img-fluid" alt="Go to taskmanager.">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
  <img src="4f8d486c-33e4-4692-971f-b65d512dad23.png" class="img-fluid" alt="Kill VMware Processes.">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
  <img src="69ee42d4-29b7-410c-8537-532364f6f64d.png" class="img-fluid" alt="Open Up Services.msc.">
