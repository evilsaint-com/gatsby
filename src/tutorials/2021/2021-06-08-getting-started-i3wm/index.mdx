...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
    <img src="7960e59e-6713-4b03-835a-0b9a261cfc1d.png" class="figure-img img-fluid border border-1 border-dark" alt="Sign-out and Log back in with i3."> 
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
    <img src="c713f525-d2c4-4593-9191-e783e0dd6d19.png" class="figure-img img-fluid border border-1 border-dark" alt="First Configuration Prompt.">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
    <img src="403fb618-ebcf-4f1d-abd2-54f93c54cb54.png" class="figure-img img-fluid border border-1 border-dark" alt="Choose Default Modifier and Write To File">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
    <img src="619b7283-5ca4-41e2-a5be-a8e4e541ede0.png" class="figure-img img-fluid border border-1 border-dark" alt="Launcher Added and Default Panel Commented Out">
