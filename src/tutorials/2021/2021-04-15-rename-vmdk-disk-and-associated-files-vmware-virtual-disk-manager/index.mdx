...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
  <img src="2d42660e-1b6f-4ccb-a499-b4ea35c8ad7e.png" class="img-fluid" alt="Explorer Windows Showing our Existing Machine.">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
  <img src="02a92320-760d-4845-916a-e4edc0ab6fdf.png" class="img-fluid" alt="Explorer window of our old vmware machine with unfriendly name">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
 <img src="6be777e4-da34-4b67-9528-367bbffcd5cb.png" class="img-fluid" alt="cmd prompt set that the location of 'vmware workstation`">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
 <img src="2a5184cd-9612-41a4-bee7-12ba20938960.png" class="img-fluid" alt="cmd promp with the `dir vmware*` showing all files begining with vmware">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
 <img src="a254b426-3829-407b-8d4c-f7a71bb0ba91.png" class="img-fluid" alt="Explorer title bar navigated to the directory of the machine we are going to be cleaning">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
 <img src="0dd01745-5d59-4429-8564-dcc8d3cb1ebf.png" class="img-fluid" alt="New Virtual Machine Wizard">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
 <img src="0d7e254f-af24-47cd-be8f-08eedb7aeaaa.png" class="img-fluid" alt="I will install the operating system later.">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12"> 
<img src="d269f440-83d2-413a-a1d5-b50e8ab33fef.png" class="img-fluid" alt="Naming the machine BlackWidow through the New Virtual Machine Wizard">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12"> 
<img src="a9e02412-2cbe-473a-8cab-b30e69d5a07d.png" class="img-fluid" alt="New Virtual Machine Wizard - Customise Options">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12"> 
<img src="8a3dd6b1-6db2-48ba-9dd6-cccf8e6586b6.png" class="img-fluid" alt="Remove Hardrive from machine settings">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12"> 
<img src="05d4c2f1-4f1b-4093-b9a4-4a28d1de2c2a.png" class="img-fluid" alt="Open VM Directory of new BlackWidow Machine">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12"> 
<img src="4abdd554-77f8-4e9c-aaad-1ce982df7ff7.png" class="img-fluid" alt="Remove the BlackWidows.vmdk file from explorer">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12"> 
<img src="e1ff1309-bdda-4c13-ba0f-bdaef6f9f371.png" class="img-fluid" alt="Remove the BlackWidows.vmdk file from explorer">
<figcaption class="figure-caption text-center fw-normal text-dark">Remove the BlackWidows.vmdk file from explorer.</figcaption>
</figure>
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12"> 
<img src="727b3493-64b1-4206-b5df-4e4fa84ddb90.png" class="img-fluid" alt="Using the vmware-vdiskmanager.exe to rename and move old machines vmdk">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12"> 
<img src="ec12321f-6996-4673-a974-11eccd2a86c1.png" class="img-fluid" alt="Add Hardware Wizard - Select Hard Disck and Click Next">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12"> 
<img src="6800f692-e604-40a1-8a06-bbdee9ff7904.png" class="img-fluid" alt="Add Hardware Wizard - Select Use an existing vitural disk">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12"> 
<img src="81aedfc6-cd7f-48b5-bf5f-e42774157a6c.png" class="img-fluid" alt="Add Hardware Wizard - Select Use an existing vitural disk">
<figcaption class="figure-caption text-center fw-normal text-dark">Add Hardware Wizard - Select Use an existing vitural disk.</figcaption>
</figure>
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12"> 
<img src="996e9216-5c62-4fd9-9da4-cf27af2d52eb.png" class="img-fluid" alt="Add Hardware Wizard - Browser to newly created BlackWidow.vmdk">
