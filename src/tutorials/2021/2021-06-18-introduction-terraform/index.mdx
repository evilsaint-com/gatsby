...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
    <img src="bdb26b17-4f49-413c-9f22-7cb1bf30631c.png" class="figure-img img-fluid border border-1 border-dark" alt="Installing Terraform with Chocolately "><figcaption class="figure-caption text-center fw-normal text-dark">  </figcaption></figure>
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
    <img src="f0248486-4143-4e96-9ff9-fb675ddd738b.png" class="figure-img img-fluid border border-1 border-dark" alt="Confirm Your Terraform Plan">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
    <img src="186e96d6-60f7-4f38-a355-3f010411687e.png" class="figure-img img-fluid border border-1 border-dark" alt="Setting Variables ">
    <figcaption class="figure-caption text-center fw-normal text-dark">Setting Variables</figcaption></figure>

Cross References

<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
    <img src="20216f1f-5ede-4823-b932-e604cbb827f4.png" class="figure-img img-fluid border border-1 border-dark" alt="Setting Cross References ">
