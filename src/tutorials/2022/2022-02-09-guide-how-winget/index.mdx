...
![Winget Not Installed By Default](3473ff07-a0b0-4652-8acd-58a5e0c2028c.png)	

Winget only supported on certain OS Versions.
@todo: Enter OS that Winget Supports

![CMD Version](1423747c-29b1-4338-b389-f34eab49ddfb.png)
...
![Installing Winget From Github](3028d678-c368-4761-944a-2a448d8de2c4.png)
...
![Click on Open To Install](6e4154f2-466b-4bf6-bf0b-44841fdb29e3.png)
...
![Winget Version](499a492e-fdda-43de-a35a-9ca967dc4452.png)
...
![Accepting The Agreement](00a6de3e-dac2-4ae2-955d-d38f2bd3eef5.png)
...
![Listing Packages Installed On The Machine](538a8041-358f-4155-be0c-d9cbc2670bed.png)
...
![Querying The List](b7543e67-b171-47dc-b1ee-330d3d953be7.png)
...
![Searching Winget For The Term Git](34d462bf-5a6f-4b4b-9ac0-58c3d38cddb6.png)
...
![Inspecint A Source](ce39df38-f611-405a-aced-f0badd8b2b47.png)

Okay, let us go back to searching.  This time we will limit our search to a source. 

![Searching By Source](28a09c06-002d-4162-9b83-823e44c94bcb.png)
...
![Searching By Tag](513804fc-8bce-499e-a753-e8e1fd76a32c.png)
...
![Searching For Microsoft Visual Studio Code](576dd63e-cb51-44c0-bbf0-1e45dca2d7de.png)

The top result looks like what we want. We can use the `show` subcommand to find more information. 

![Using The Show Command](937e36c4-3bd2-4a63-bccc-efc82e4860c1.png)
...
![Referencing By Moniker](965b468d-94aa-485c-99dd-9f8412668318.png)
...
![Installing Visual Studio Code](3a9134d0-16b8-4b59-aaa6-b4ad84f84d1e.png)

Great so our package is now installed. 

When installing you may see UI windows open like in the screenshot below. 

![Installing the Github CLI](f43a3347-59c3-4dd0-8893-e0f64d56b23f.png)
...
```
![Uninstall Github CLI](e8b7f955-ffc7-43ce-803f-e925dc5a336d.png)

Installing with the `--silent` flag. 

![Installing Silentlly](7ce4226c-49e4-4a9a-9127-6c2a655d1baf.png)
...
```
![Exporting List Of Packages](ed2c9105-f0ab-417a-8de1-a64c7ecbead3.png)
