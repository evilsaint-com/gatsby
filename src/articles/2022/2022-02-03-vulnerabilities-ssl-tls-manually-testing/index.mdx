...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12"><img src="6b0fdc3f-f387-44ca-9ddc-08cacb6cc151.png" class="figure-img img-fluid border border-1 border-dark" alt=" "><figcaption class="figure-caption text-center fw-normal">Number of Ciphers Supported Between Versions  1.1.1l and 1.0.2g</figcaption></figure>
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12"><img src="b644efe1-38f3-49b1-a45c-eb4b57693e5b.png" class="figure-img img-fluid border border-1 border-dark" alt=" "><figcaption class="figure-caption text-center fw-normal">Cropped Image of OpenSSL Binary Listing Standard Commands</figcaption></figure>
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12"><img src="2a69cc1d-4400-4ff3-8875-0da4e92e1158.png" class="figure-img img-fluid border border-1 border-dark" alt=" "><figcaption class="figure-caption text-center fw-normal">Support for ~142 Ciphers </figcaption></figure>

```
testssl https://evilsaint.com
```

<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12"><img src="10d48df7-e237-4dcc-8fa6-7ec25875b8c9.png" class="figure-img img-fluid border border-1 border-dark" alt=" "><figcaption class="figure-caption text-center fw-normal">Support for ~81  Ciphers</figcaption></figure>
