...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
  <img src="734c9b10-1b51-4fb7-81d1-d56a5156429d.png" class="img-fluid" alt="Opening Windows CMD Prompt from Start Menu">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
  <img src="e02c6fea-e50d-4b4d-9bf0-d6734745df23.png" class="img-fluid" alt="Elevated PowerShell Prompt">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
  <img src="1e875c32-3ae8-4948-b3c4-8d8d0704f647.png" class="img-fluid" alt="Windows Version Information Displayed Via winver Command">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
 <img src="747d8148-d1a5-49f1-b37a-20a03d0726e4.png" class="img-fluid" alt="PowerShell 7 Installing Optional Actions">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
 <img src="b5b9a5ef-6cab-469e-b646-cdf2e102ab88.png" class="img-fluid" alt="Right click pin to taskbar">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
<img src="d5102f1f-3474-4de9-b731-3c000bbff513.png" class="img-fluid" alt="PowerShell 7 Get Version Information with $PSVersionTable"><figcaption class="figure-caption text-center fw-normal text-dark">PowerShell 7 Get Version Information with $PSVersionTable.</figcaption>
</figure>
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
<img src="f01e5588-7993-4a9a-963f-0a6f28881677.png" class="img-fluid" alt="Installing Optional Features">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
<img src="20b5093a-ed64-44f2-9f85-330caca77ad6.png" class="img-fluid" alt="Download the Linux Kernel Update package for WSLv2">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
<img src="c7684b40-9f63-46d9-aa4f-2ed48d6c4bfc.png" class="img-fluid" alt="Click the msi installer">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
<img src="dc8ef383-d7c5-4d2d-9be0-90afdb2b03ce.png" class="img-fluid" alt="Using the wsl --list versions command">
...
```
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
<img src="edde105e-d633-41fc-a530-09a3eea6a75d.png" class="img-fluid" alt="Coverting Kali-Linux WSLv1 to WSLv2">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
<img src="c40c343c-f360-46fb-8ac9-b4b008324e35.png" class="img-fluid" alt="Installing Visual Studio Code">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
<img src="c91f8c40-7c3e-4239-b2a2-6e2e4173bb37.png" class="img-fluid" alt="Running and Installing Visual Studio inside WSL">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
<img src="c92e6a86-96b6-4893-a656-865c78d9f0a4.png" class="img-fluid" alt="Docker Installer">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
<img src="f62567a0-2ccb-4b42-a55c-a4e2d29a1a79.png" class="img-fluid" alt="The New Shell">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
<img src="94d8933c-ec62-43c3-afb0-6300e5dc86a3.png" class="img-fluid" alt="Pin terminal to the taskbar">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
<img src="0223b9ef-976a-491a-bed5-c703f8b79a3f.png" class="img-fluid" alt="Pin terminal to the taskbar">
<figcaption class="figure-caption text-center fw-normal text-dark">Pin terminal to the taskbar.</figcaption>
</figure>
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
<img src="2c1826a5-6222-4c83-9f06-9999146253f0.png" class="img-fluid" alt="Install Font for all users">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
<img src="03e3cc64-862a-4dd2-9b5a-460007938604.png" class="img-fluid" alt="Install Hyper For Windows">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
<img src="ad210a8d-8793-4ffc-b538-7e36b1e2d0a4.png" class="img-fluid" alt="Open HyperShell">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
<img src="47315b04-6d39-4fb7-b421-83d9e7f2b346.png" class="img-fluid" alt="Confirm the installation of Chocolatey">
...
<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
<img src="d65ee216-1714-45cf-b4ac-8bc5587beba9.png" class="img-fluid" alt="Windows Terminal Help">
<figcaption class="figure-caption text-center fw-normal text-dark">Windows Terminal Help.</figcaption>
</figure>

<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
<img src="41873b36-7aac-435e-8b51-1a6a566f0a31.png" class="img-fluid" alt="Windows Terminal Help - Split Pane">
<figcaption class="figure-caption text-center fw-normal text-dark">Windows Terminal Help - Split Pane.</figcaption>
</figure>

<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
<img src="21ca4b80-a019-4029-b4ea-41fa193bef73.png" class="img-fluid" alt="Windows Terminal Help - New Tab">
<figcaption class="figure-caption text-center fw-normal text-dark">Windows Terminal Help - New Tab.</figcaption>
</figure>

<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
<img src="1b6288b6-c34f-4939-b680-c11726d58814.png" class="img-fluid" alt="Windows Terminal Help - Focus Tab">
<figcaption class="figure-caption text-center fw-normal text-dark">Windows Terminal Help - Focus Tab.</figcaption>
</figure>

<figure class="figure text-center col-xs-12 col-sm-12 col-lg-12">
<img src="06677c06-0359-4f30-b953-8fb6cfd31724.png" class="img-fluid" alt="Two Versions Of Kali">
